...
ApplicationMain.preloader_onComplete = function(event) {
	...
	if(hasMain) Reflect.callMethod(piratepig.PiratePig,Reflect.field(piratepig.PiratePig,"main"),[]); else {
		...
		if(js.Boot.__instanceof(instance,openfl.display.DisplayObject)) openfl.Lib.current.addChild(instance); else {
			haxe.Log.trace("Error: No entry point found",{ fileName : "ApplicationMain.hx", lineNumber : 466, className : "ApplicationMain", methodName : "preloader_onComplete"});
			haxe.Log.trace("If you are using DCE with a static main, you may need to @:keep the function",{ fileName : "ApplicationMain.hx", lineNumber : 467, className : "ApplicationMain", methodName : "preloader_onComplete"});
		}
	}
};
...
piratepig.PiratePigGame.tileImages = ["images/applejack_clapping.gif","images/psychoticmushrooom.gif","images/ispanol.png","images/game_lemon.png","images/pony.png","images/game_piratePig.png"];

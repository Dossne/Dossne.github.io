...
ApplicationMain.preloader_onComplete = function(event) {
	...
	if(hasMain) Reflect.callMethod(piratepig.PiratePig,Reflect.field(piratepig.PiratePig,"main"),[]); else {
		...
		if(js.Boot.__instanceof(instance,openfl.display.DisplayObject)) openfl.Lib.current.addChild(instance); else {
			haxe.Log.trace("Error: No entry point found",{ fileName : "ApplicationMain.hx", lineNumber : 554, className : "ApplicationMain", methodName : "preloader_onComplete"});
			haxe.Log.trace("If you are using DCE with a static main, you may need to @:keep the function",{ fileName : "ApplicationMain.hx", lineNumber : 555, className : "ApplicationMain", methodName : "preloader_onComplete"});
		}
	}
};
...
piratepig.PiratePigGame.NUM_COLUMNS = 16;
piratepig.PiratePigGame.NUM_ROWS = 16;
piratepig.PiratePigGame.tileImages = ["images/2712.gif","images/picka.jpg","images/monster.jpg","images/death.jpg","images/2717.gif","images/2715.gif"];
